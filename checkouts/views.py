...
from assinaturas.models import SubscriptionPrice, Subscription, UserSubscription
...
def checkout_redirect_view(request):
    ...
    cliente = Customer.objects.get(user=request.user)
    customer_stripe_id = cliente.stripe_id
